...
def _get_resnet_weights(num_layers, pretrained):
    if not pretrained:
        return None
    weights = {
...
def resnet_multiimage_input(num_layers, pretrained=False, num_input_images=1):
    ...
    if pretrained:
        # torchvision 0.15+ removed models.resnet.model_urls.
        model_urls = {
        ...
        loaded = torch.hub.load_state_dict_from_url(model_urls[num_layers])
...
class ResnetEncoder(nn.Module):
    ...
    def __init__(self, num_layers, pretrained, num_input_images=1):
        ...
        if num_input_images > 1:
            ...
            self.encoder = resnets[num_layers](weights=_get_resnet_weights(num_layers, pretrained))
