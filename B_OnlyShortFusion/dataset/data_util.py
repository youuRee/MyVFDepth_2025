...
_DEL_KEYS= ['rgb', 'rgb_context', 'rgb_original', 'rgb_context_original', 'intrinsics', 'contexts', 'splitname', 'cur_depth', 'prev_depth', 'next_depth', 'prev_pose', 'next_pose', 'point_cloud', 'point_context'] 
